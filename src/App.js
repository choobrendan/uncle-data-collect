...
const App = () => {
  ...
  const animatePhysics = (time) => {
    ...
    if (currentConfig.netMovement) {
      const newNetOffset = Math.sin(time * 0.005 * currentConfig.netMoveSpeed) * 200;
  ...
  return (
    <div className="container">
      ...
      >
        ...
        <div className="hoop" style={{ left: hoopPosition.x - hoopWidth/2 + netOffset, top:hoopPosition.y , zIndex:100}}>
...
/> */}
        <div className="net" style={{ left: hoopPosition.x - hoopWidth/2 + netOffset+ 10 ,top:hoopPosition.y+rimWidth,zIndex:100}}/>
        </div>
        <div 
          className="ball"
          style={{ left: ballPosition.x - ballRadius, top: ballPosition.y - ballRadius }}
        >
